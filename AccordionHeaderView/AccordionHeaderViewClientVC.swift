...
/// This class acts as a client of `AccordionHeaderViewDelegate`.
open class AccordionHeaderViewClientVC: UIViewController, AccordionHeaderViewClient, UIScrollViewDelegate {

    /// Stores the last recorded vertical offset of the scroll view.
    public var previousContentOffsetY: CGFloat = 0.0

    /// A Boolean indicating whether deceleration is currently in progress.
    public var decelerationInProgress: Bool = false
